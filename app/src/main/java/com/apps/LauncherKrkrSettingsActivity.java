...
public class LauncherKrkrSettingsActivity extends AppCompatActivity {
    ...
    private void loadConfig() {
        ...
        binding.compatModeSwitch.setChecked(LauncherKrkrBridge.isCompatMode(this));
    ...
    private void save() {
        ...
        LauncherKrkrBridge.setCompatMode(this, binding.compatModeSwitch.isChecked());
        ...
        Toast.makeText(this, "KRKR 引擎设置已保存：" + LauncherKrkrBridge.engineVersionLabel(version), Toast.LENGTH_SHORT).show();
        finish();
    }
