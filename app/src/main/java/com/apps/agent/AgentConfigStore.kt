...
object AgentConfigStore {
    ...
    internal const val PERMISSION_RESTRICTED = "restricted"
    internal const val PERMISSION_FULL = "full"
    internal const val DEFAULT_CONTEXT_BUDGET_KB = 72
    ...
    internal fun getApiKey(context: Context): String {
    ...
    internal fun validateToolCalls(value: Int): Int {
    ...
    internal fun validateContextBudgetKb(value: Int): Int {
    ...
    internal fun validatePermissionMode(value: String?): String {
