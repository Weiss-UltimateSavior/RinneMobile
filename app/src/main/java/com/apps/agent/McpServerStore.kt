...
internal object McpServerStore {
    ...
    internal fun add(context: Context, name: String?, endpoint: String?): Server {
    ...
    @JvmName("get")
    @Throws(Exception::class)
    internal fun get(context: Context, id: String?): Server {
    ...
    @JvmName("remove")
    @Throws(Exception::class)
    internal fun remove(context: Context, id: String?): Server {
        val servers = read(context)
    ...
    @JvmName("list")
    @Throws(Exception::class)
    internal fun list(context: Context): String {
        val items = JSONArray()
    ...
    @Throws(Exception::class)
    internal fun trustedModelContext(context: Context): String {
    ...
    @Throws(Exception::class)
    internal fun savedSummary(context: Context): String {
        val servers = read(context)
    ...
    @Throws(Exception::class)
    internal fun findByEndpoint(context: Context, endpoint: String?): Server? {
        val safeEndpoint = validateEndpoint(endpoint)
    ...
    @JvmStatic
    @JvmName("preview")
    internal fun preview(server: Server): String {
    ...
    @JvmStatic
    @JvmName("isPrivateNetworkHost")
    internal fun isPrivateNetworkHost(value: String?): Boolean {
    ...
    @JvmName("decode")
    @Throws(Exception::class)
    internal fun decode(raw: String?): MutableList<Server> {
    ...
    @JvmName("encode")
    @Throws(Exception::class)
    internal fun encode(servers: List<Server>): String {
