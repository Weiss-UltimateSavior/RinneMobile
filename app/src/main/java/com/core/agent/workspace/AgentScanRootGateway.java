...
public final class AgentScanRootGateway {
    ...
    public static String listRoots(Context context) throws Exception {
    ...
    public static String listFiles(Context context, String rootId, String relativePath, int depth, int limit,
    ...
    public static PendingOperation prepare(Context context, JSONObject args) throws Exception {
    ...
    public static String commit(Context context, PendingOperation pending,
                         GameWorkspaceGateway.CancellationProbe cancellation) throws Exception {
        checkActive(cancellation);
    ...
    public static final class PendingOperation {
        ...
        final String sourceIdentity; final String parentIdentity; final List<GameBinding> bindings; public final String preview;
    ...
    public static final class MutationFailure extends IOException { public MutationFailure(String message, Throwable cause) { super(message, cause); } }
