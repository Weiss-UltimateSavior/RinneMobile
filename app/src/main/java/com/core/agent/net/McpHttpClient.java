...
public final class McpHttpClient {
    ...
    public McpHttpClient() { this(() -> { }); }

    public McpHttpClient(Runnable onToolRequestStarted) {
        this.onToolRequestStarted = onToolRequestStarted == null ? () -> { } : onToolRequestStarted;
    }

    public static final class Session {
        public final McpServerStore.Server server;
        public final String sessionId;
        public final String protocolVersion;
        public Session(McpServerStore.Server server, String sessionId, String protocolVersion) {
            this.server = server; this.sessionId = sessionId; this.protocolVersion = protocolVersion;
        }
    }

    public Session open(McpServerStore.Server server) throws Exception {
    ...
    public JSONObject listTools(Session session) throws Exception {
    ...
    public JSONObject callTool(Session session, String toolName, JSONObject arguments) throws Exception {
